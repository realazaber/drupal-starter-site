...
class __TwigTemplate_a956a8c829ab510bf6d190160b676a6f229a5ddca782f7aaea1d175bb12e4789 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["icon"] ?? null) && ($context["icon_position"] ?? null)) &&  !($context["icon_only"] ?? null))) ? (("icon-" . $this->sandbox->ensureToStringAllowed(($context["icon_position"] ?? null), 30, $this->source))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/bootstrap/templates/input/input--button.html.twig", "/opt/lampp/htdocs/projects/drupal-starter-site/drupal-starter-site/web/themes/contrib/bootstrap/templates/input/input--button.html.twig");
    }
